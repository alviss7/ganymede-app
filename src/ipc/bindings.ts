...
const ARGS_MAP = {'base':'{"newId":[],"openUrl":["url"]}', 'almanax':'{"get":["level","date"]}', 'image':'{"fetchImage":["url"]}', 'security':'{"getWhiteList":[]}', 'guides':'{"getGuidesFromServer":["status"],"downloadGuideFromServer":["guide_id","folder"],"getFlatGuides":["folder"],"openGuidesFolder":[],"getGuideFromServer":["guide_id"],"getGuides":["folder"]}', '':'{"isAppVersionOld":[]}', 'conf':'{"set":["conf"],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"reset":[],"get":[]}', 'update':'{"startUpdate":[]}'}
