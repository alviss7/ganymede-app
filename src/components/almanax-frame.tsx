    ...
    <div className="mx-4 flex grow items-center justify-center rounded border p-2">
      ...
      {almanax.isSuccess && (
        <div className="flex flex-col gap-0.5">
          ...
          <div className="text-center text-xs">{almanax.data.experience.toLocaleString()} EXP</div>
          <div className="text-center text-xs">{almanax.data.kamas.toLocaleString()} KAMAS</div>
          <div
